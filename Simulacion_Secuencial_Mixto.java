...
import static simulación.SimulaciónSecuencial_Multiplicativo.esPrimo;

/**
 *
 * @author camila
 */
public class Simulacion_Secuencial_Mixto {

    public static void main(String[] args) {
        int R, c, primo = 0;
        String cadena="";//almacena el resultado en una cadena de caracteres
        int contador=1;//contabiliza el periodo total 
        double d = Double.parseDouble(JOptionPane.showInputDialog(null, "Para poder obtener m =2^d,"+"/n"+"  Igrese el valor de D","Valor D", 
        ...
        int a = 1 + (4 * k);//para obtener el valor de a se lo hace a partir de este formulo o bien con la sigiente: 1 + (4 * k)
